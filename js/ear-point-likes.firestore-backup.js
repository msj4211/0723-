// Firestore 기반 원본 백업. index.html에서 로드하지 않는 비활성 파일이다.
// Supabase 전환(js/ear-point-likes.js)의 회원가입/로그인/로그아웃/좋아요 추가삭제/
// 새로고침 유지 테스트가 모두 통과하면, 이 파일과 Firebase 스크립트 태그를 제거한다.
